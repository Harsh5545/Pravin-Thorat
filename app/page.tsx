...
export default function PravinThoratWebsite() {
  ...
  const services = [
    {
      ...
      title: "Mutual Funds",
      description:
        "Build wealth systematically with expert-guided mutual fund investments",
      features: [
    ...
    },
    {
      ...
      description:
        "Comprehensive life protection solutions for your family's security",
      features: [
        "Term Life Insurance",
        "ULIP Plans",
        "Endowment Policies",
    ...
    },
    {
      ...
      description:
        "Medical coverage plans to protect against healthcare expenses",
      features: [
    ...
    },
    {
      ...
      description:
        "Secure your golden years with comprehensive retirement strategies",
      features: [
  ...
  const achievements = [
    ...
    { number: "₹20Cr+", label: "Assets Under Advisory", icon: TrendingUp },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-blue-400 font-semibold mb-6">
                20+ Years of Excellence in Financial Planning
              </p>
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                Helping families and professionals in Mumbai secure their
                financial future through expert guidance in insurance, mutual
                funds, and comprehensive financial planning.
              </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              A dedicated financial professional committed to helping you
              achieve your financial dreams through expert guidance and
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                With over 15 years of dedicated experience in the insurance and
                financial services industry, I have helped over 500+ families
                and working professionals in Mumbai and surrounding areas secure
                their financial future through smart investment strategies and
                comprehensive insurance planning.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                My approach is built on understanding each client's unique
                financial situation, goals, and risk appetite. I believe in
                providing transparent, honest advice that puts your interests
                first, ensuring you make informed decisions about your financial
                future.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
                As a certified IRDAI agent and registered mutual fund advisor, I
                stay updated with the latest market trends and regulatory
                changes to provide you with the most current and effective
                financial solutions.
              </p>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-blue-600 to-blue-700 p-6 rounded-lg">
                  ...
                  <p className="text-blue-100 text-sm">
                    Certified Financial Planner with continuous professional
                    development
                  </p>
                </div>
                <div className="bg-gradient-to-br from-red-600 to-red-700 p-6 rounded-lg">
                  ...
                  <p className="text-red-100 text-sm">
                    Insurance, Mutual Funds, Retirement & Tax Planning
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-slate-700 p-4 rounded-lg">
                    ...
                    <p className="text-white font-bold">20+ Years</p>
                  </div>
                </div>
              </div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="text-white">
                      20+ years of proven track record with 500+ satisfied
                      clients
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-6 w-6 text-green-400 mr-3 mt-1 flex-shrink-0" />
                    <span className="text-white">
                      Certified IRDAI agent with proper licensing and compliance
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-6 w-6 text-green-400 mr-3 mt-1 flex-shrink-0" />
                    <span className="text-white">
                      Personalized financial solutions tailored to your unique
                      needs
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-6 w-6 text-green-400 mr-3 mt-1 flex-shrink-0" />
                    <span className="text-white">
                      End-to-end support from planning to claim settlement
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-6 w-6 text-green-400 mr-3 mt-1 flex-shrink-0" />
                    <span className="text-white">
                      Transparent advice with no hidden charges or commissions
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto">
              From insurance protection to wealth creation, I offer complete
              financial solutions tailored to your life goals and risk profile.
            </p>
      ...
      <section id="portfolio" className="py-20 px-4 bg-slate-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Over 15 years of helping clients achieve their financial goals
            ...
            <Card className="bg-gradient-to-br from-blue-600 to-blue-700 border-0 text-white">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-blue-100 mb-4">
                  95% of my clients achieve their financial goals on time
                </p>
            ...
            <Card className="bg-gradient-to-br from-red-600 to-red-700 border-0 text-white">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-red-100 mb-4">
                  Successful claim settlement rate with my assistance
                </p>
      ...
      <section id="testimonials" className="py-20 px-4 bg-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Real experiences from real people who trusted me with their
              financial future.
            </p>
            <div className="w-24 h-1 bg-blue-500 mx-auto mt-8"></div>
          </div>
      ...
      <section id="faq" className="py-20 px-4 bg-slate-900">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400">
              Get answers to common questions about financial planning and
              insurance.
            </p>
            <div className="w-24 h-1 bg-blue-500 mx-auto mt-8"></div>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto">
              Ready to take control of your financial destiny? Get in touch for
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Follow for financial tips & updates
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12 p-6 bg-blue-900/30 rounded-lg border border-blue-500/30">
                <h4 className="text-blue-300 text-lg font-semibold mb-4">
                  Office Hours
                </h4>
                <div className="space-y-2 text-gray-300">
                  ...
                  <p>
                    <span className="font-medium">Sunday:</span> 10:00 AM - 5:00
                    PM
                  </p>
                </div>
            ...
            <div className="space-y-8">
              <Card className="bg-slate-800 border-slate-700">
                ...
                <CardContent>
                  <p className="text-gray-300 mb-6">
                    Get personalized financial advice tailored to your goals. No
                    obligation, just expert guidance to help you make informed
              ...
              <Card className="bg-gradient-to-br from-red-600 to-blue-600 border-0 text-white">
                <CardContent className="p-8">
                  ...
                  <p className="mb-6">
                    Get a comprehensive review of your current financial
                    situation and receive personalized recommendations for
                    improvement.
                  </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Your trusted financial partner for insurance, mutual funds, and
